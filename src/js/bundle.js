...
// imports
exports.push([module.i, "@import url(https://fonts.googleapis.com/css?family=Crimson+Text|Lato:300);", ""]);

// module
exports.push([module.i, ":root {\n  font-size: 30px; }\n\n* {\n  font-size: 1rem;\n  font-family: 'Crimson Text', serif;\n  -webkit-box-sizing: border-box;\n  -moz-box-sizing: border-box;\n  box-sizing: border-box;\n  -webkit-transition: all 500ms ease-out;\n  -moz-transition: all 500ms ease-out;\n  transition: all 500ms ease-out; }\n\nhtml {\n  position: relative;\n  min-width: 200px;\n  min-height: 100%; }\n\nbody {\n  background-color: #FEFDFF;\n  color: #383838; }\n\na, a:link, a:visited, a:hover, a:active {\n  color: #383838;\n  text-decoration: none; }\n\nh1 {\n  font-size: 2rem;\n  font-family: 'Lato', sans-serif;\n  font-weight: 300;\n  color: #49347F; }\n\n#title {\n  font-size: 2.5rem;\n  font-family: 'Crimson Text', serif;\n  margin-top: 0.8rem; }\n\n#wrapper {\n  position: absolute;\n  top: 40%;\n  left: 0;\n  width: 100%; }\n\n#search, #random {\n  margin: 0.3rem auto; }\n\n#search {\n  width: 11rem; }\n\n#random {\n  width: 8rem; }\n\n.icon {\n  width: 2rem;\n  height: 2rem;\n  margin: 0 auto;\n  border: 0.1rem solid #383838;\n  border-radius: 1rem;\n  vertical-align: middle; }\n\n#search i {\n  line-height: 1.7rem; }\n\n#search input {\n  width: 0rem;\n  background: transparent;\n  border: transparent;\n  outline-width: 0px; }\n\n#random {\n  padding-bottom: 2rem; }\n  #random .icon {\n    display: inline-block;\n    white-space: nowrap;\n    overflow: hidden; }\n  #random i {\n    line-height: 1.9rem;\n    margin-left: 0.25rem; }\n  #random span {\n    display: inline-block;\n    width: 5rem; }\n\n#search:hover .icon {\n  width: 10rem; }\n  #search:hover .icon input {\n    width: 8rem; }\n\n#random:hover .icon {\n  width: 7rem; }\n\n#results {\n  position: relative;\n  margin: 2rem; }\n\nfooter {\n  position: absolute;\n  bottom: 0.8rem;\n  left: 0;\n  width: 100%;\n  text-align: center;\n  color: #7AB039; }\n  footer small {\n    font-size: 0.6rem; }\n  footer a {\n    font-size: 0.6rem; }\n\n.active {\n  position: relative !important;\n  top: 0 !important; }\n\n.text-left {\n  text-align: left; }\n\n.text-center {\n  text-align: center; }\n\n.text-right {\n  text-align: right; }\n\n.active-search {\n  width: 10rem !important; }\n\n.active-input {\n  width: 8rem !important; }\n", ""]);
...
(0, _jquery2.default)(document).ready(function () {
  ...
  (0, _jquery2.default)('#results').hide();

  (0, _jquery2.default)('#search').mouseleave(function toggleSearchBar() {
    var input = (0, _jquery2.default)('input');

    if (input.val().length > 0) {
      input.addClass('active-input');
      (0, _jquery2.default)('#search .icon').addClass('active-search');
    } else {
      input.removeClass('active-input');
      (0, _jquery2.default)('#search .icon').removeClass('active-search');
    }
  });

  (0, _jquery2.default)('#search i').on('click', search);
  (0, _jquery2.default)('input').keypress(function (e) {
    if (e.which == 13) search();
  });

  function search() {
    var searchTerm = (0, _jquery2.default)('#search input').val();
    changeTitle(searchTerm);

    if (searchTerm) {
      _jquery2.default.get('' + wikipediaSearchURL + searchTerm, function (_ref, data) {
        var results = _ref.query.search;
